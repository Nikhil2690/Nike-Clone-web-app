...
const SpecialOffer = () => {
  return (
    ...
    gap-10 max-container">
      ...
      className="object-containerw-full"
      />
      </div>
      ...
      flex-col">
         ...
         lg:max-w-lg">
          ...
          info-text'>
            ...
            deals. From premier selection to
            incredible savings, We offer unparalleled
            value that sets us apart.
          </p>
          <p className="mt-6 lg:max-w-lg
          info-text">
            Navigate a realm of possibilities designed 
            to fulfill your unique desires, surpassing the 
            loftiest expectations, Your journey with 
